...
import ro.alintudor.luxoculi.core.OracleDemo
import ro.alintudor.luxoculi.core.OracleGrowthEmergency
import ro.alintudor.luxoculi.core.OracleGrowthEngine
import ro.alintudor.luxoculi.core.OracleGrowthJournalStore
import ro.alintudor.luxoculi.core.OracleGrowthPhase
import ro.alintudor.luxoculi.core.OracleGrowthProgress
import ro.alintudor.luxoculi.core.OracleGrowthRecommendation
import ro.alintudor.luxoculi.core.OracleLoaderQuotes
import ro.alintudor.luxoculi.core.OracleNews
...
class OracleGrowthModule(private val host: OracleNativeModule) {
    ...
    private fun addLoadingState() {
        ...
        val spinner = ImageView(host.root.context).apply {
            setImageResource(ro.alintudor.luxoculi.R.drawable.ic_oracle)
    ...
    private fun addRecommendationCard(item: OracleGrowthRecommendation, news: List<OracleNews>, index: Int = 0, silent: Boolean = false) {
        ...
        OracleFactorGrid.add(host, card, "Weights", item.weights, item.weights.maxOrNull() ?: 1, item.hazard, silent)
